...
def download_iso [] {
  ...
  if not ($filename | path exists) {
    https download https://geo.mirror.pkgbuild.com/iso/latest/archlinux-x86_64.iso -o $filename
  }
}
...
def download_qcow2 [] {
  ...
  if not ($filename | path exists) {
    https download https://geo.mirror.pkgbuild.com/images/latest/Arch-Linux-x86_64-basic.qcow2 -o $filename
  }
}
