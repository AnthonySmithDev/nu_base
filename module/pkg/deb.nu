...
def filepath [name: string, version: string] {
  $env.USR_LOCAL_SHARE_DOWNLOAD | path join $'($name)_($version).deb'
}
...
export def vieb [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/Jelmerro/Vieb/releases/download/($version)/vieb_($version)_amd64.deb $path
    install $path
  }
}
...
export def brave [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/brave/brave-browser/releases/download/v($version)/brave-browser_($version)_amd64.deb $path
    install $path
  }
}
...
export def chrome [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://dl.google.com/linux/direct/google-chrome-stable_current_amd64.deb $path
    install $path
  }
}
...
export def opera [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://download5.operacdn.com/ftp/pub/opera/desktop/($version)/linux/opera-stable_($version)_amd64.deb $path
    install $path
  }
}
...
export def vscodium [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/VSCodium/vscodium/releases/download/($version)/codium_($version)_amd64.deb $path
    install $path
  }
}
...
export def mysql-workbench [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://dev.mysql.com/get/Downloads/MySQLGUITools/mysql-workbench-community_($version)_amd64.deb $path
    install $path
  }
}
...
export def microsoft-edge [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://packages.microsoft.com/repos/edge/pool/main/m/microsoft-edge-stable/microsoft-edge-stable_($version)_amd64.deb?brand=M102 $path
    install $path
  }
}
...
export def steam [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://cdn.cloudflare.steamstatic.com/client/installer/steam.deb $path
    install $path
  }
}
...
export def via [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $"https://github.com/the-via/releases/releases/download/v($version)/via-($version)-linux.deb" $path
    install $path
  }
}
...
export def discord [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://discord.com/api/download?platform=linux&format=deb $path
    install $path
  }
}
...
export def input-remapper-file [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/sezanzeb/input-remapper/releases/download/($version)/input-remapper-($version).deb $path
    install $path
...
export def balena-etcher [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/balena-io/etcher/releases/download/v($version)/balena-etcher_($version)_amd64.deb $path
    install $path
  }
}
...
export def obsidian [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/obsidianmd/obsidian-releases/releases/download/v($version)/obsidian_($version)_amd64.deb $path
    install $path
  }
}
...
export def localsend [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $'https://github.com/localsend/localsend/releases/download/v($version)/LocalSend-($version)-linux-x86-64.deb' $path
    install $path
  }
}
...
export def appflowy [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $'https://github.com/AppFlowy-IO/AppFlowy/releases/download/($version)/AppFlowy-($version)-linux-x86_64.deb' $path
    install $path
  }
}
...
export def siyuan [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $'https://github.com/siyuan-note/siyuan/releases/download/v($version)/siyuan-($version)-linux.deb' $path
    install $path
  }
}
...
export def sftpgo [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $'https://github.com/drakkan/sftpgo/releases/download/v($version)/sftpgo_($version)-1_amd64.deb' $path
    install $path
  }
}
...
export def rio [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $'https://github.com/raphamorim/rio/releases/download/v($version)/rio_($version)-1_amd64_wayland.deb' $path
    install $path
  }
}
...
export def qopy [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $"https://github.com/0PandaDEV/Qopy/releases/download/v($version)/Qopy-($version).deb" $path
    install $path
  }
}
...
export def runjs [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/lukehaas/RunJS/releases/download/v($version)/runjs_($version)_amd64.deb $path
    install $path
  }
}
...
export def warp [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://app.warp.dev/download?package=deb $path
    install $path
  }
}
...
export def hoppscotch [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/hoppscotch/releases/releases/latest/download/Hoppscotch_linux_x64.deb $path
    install $path
  }
}
...
export def lapce [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download https://github.com/lapce/lapce/releases/download/v($version)/lapce.ubuntu.mantic.amd64.deb $path
    install $path
  }
}
...
export def pacstall [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $'https://github.com/pacstall/pacstall/releases/download/($version)/pacstall_($version)-pacstall1_all.deb' $path
    install $path
  }
}
...
export def contour [ --force(-f) ] {
  ...
  if (path-not-exists $path $force) {
    download $'https://github.com/contour-terminal/contour/releases/download/v($version)/contour-($version)-ubuntu24.04-amd64.deb' $path
    install $path
  }
}
